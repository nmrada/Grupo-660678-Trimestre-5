...
public class Usuario {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Visualización del catalogo tras ejecutar la primera solicitud");
        catalogo.visualiza();
        System.out.println("");
        SolicitudRebaja solicitudRebaja2 = new SolicitudRebaja(10, 5, 0.5);
        catalogo.ejecutaSolicitudRebaja(solicitudRebaja2);
        System.out.println("Visualización del catalogo tras ejecutar la segunda solicitud");
        catalogo.visualiza();
        System.out.println("");
