...
public class CustommerDAOMysqlImpl implements CustommerDAO{
    ...
    public void insert(PeopleDTO p) {
        System.out.println("Inserte cliente en Mysql "+p.toString());
    }

    @Override
    public void update(PeopleDTO p) {
        System.out.println("Actualice cliente en Mysql "+p.toString());
    }

    @Override
    public void delete(PeopleDTO p) {
        System.out.println("Borre cliente en Mysql "+p.toString());
    }

    @Override
    public void findByID(PeopleDTO p) {
        System.out.println("Se busco el cliente en Mysql "+p.toString());
    }

    @Override
    public void insert(Collection<PeopleDTO> p) {
        for (PeopleDTO p1 : p) {
            System.out.println("Inserto el cliente en Mysql "+p.toString());
        }
    }
