...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT idDepartamento, nombre FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( idDepartamento, nombre ) VALUES ( ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET idDepartamento = ?, nombre = ? WHERE idDepartamento = ?";
	...
	/** 
	 * Returns all rows from the departamento table that match the criteria 'nombre = :nombre'.
	 */
	public Departamento[] findWhereNombreEquals(String nombre) throws DepartamentoDaoException
	{
	...
	{
		return "tiendaenlinea.departamento";
	}
