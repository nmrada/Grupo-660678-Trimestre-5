...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT idMunicipio, nombre, Departamento_idDepartamento FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( idMunicipio, nombre, Departamento_idDepartamento ) VALUES ( ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET idMunicipio = ?, nombre = ?, Departamento_idDepartamento = ? WHERE idMunicipio = ?";
	...
	public void update(MunicipioPk pk, Municipio dto) throws MunicipioDaoException
	{
		...
		try {
			...
			stmt.setString( index++, dto.getNombre() );
			stmt.setString( index++, dto.getDepartamentoIddepartamento() );
			stmt.setString( 4, pk.getIdMunicipio() );
			int rows = stmt.executeUpdate();
			reset(dto);
			long t2 = System.currentTimeMillis();
			System.out.println( rows + " rows affected (" + (t2-t1) + " ms)" );
	...
	/** 
	 * Returns all rows from the municipio table that match the criteria 'nombre = :nombre'.
	 */
	public Municipio[] findWhereNombreEquals(String nombre) throws MunicipioDaoException
	{
	...
	{
		return "tiendaenlinea.municipio";
	}
