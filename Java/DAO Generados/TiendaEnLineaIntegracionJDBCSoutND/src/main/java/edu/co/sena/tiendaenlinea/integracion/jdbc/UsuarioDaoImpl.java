...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT idUsuario, contrasena, rol, estado FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( idUsuario, contrasena, rol, estado ) VALUES ( ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET idUsuario = ?, contrasena = ?, rol = ?, estado = ? WHERE idUsuario = ?";
	 ...
	 */
	protected static final int COLUMN_CONTRASENA = 2;
